defmodule Server.EconomyTest do
  ...
  describe "purchase" do
    # A cheap color (def 100) and a dear one (def 101); a new account starts with 120 coins
    ...
    setup do
      insert_def(%{
        ...
        name: "Rose Blush",
        category: "color",
        base_attributes: %{"color_slot" => "skin_tone", "ramp" => "rose", "price" => 30, "currency" => "coins"}
      })
      ...
      insert_def(%{
        ...
        name: "Dear Plum",
        category: "color",
        base_attributes: %{"ramp" => "plum", "price" => 100_000, "currency" => "coins"}
      })
    ...
    test "an unaffordable color rolls back with nothing moved", %{user: user} do
      ...
      assert Economy.balance(user, "coins") == start
    ...
    test "buying the same color twice is refused", %{user: user} do
      ...
      assert Economy.balance(user, "coins") == 120 - 30
    end
